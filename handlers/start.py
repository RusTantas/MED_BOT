...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        f"Добро пожаловать!\n"
        f"Это чат-бот доктора {AUTHOR_NAME}. "
        ...
        "Если вы еще не подписаны на мой блог, обязательно подпишитесь: \n"
        "@dr_halimova_gulnaz ❤️"
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🌿 Здоровое тело", callback_data="product")],
